...
const projects: Project[] = [
  {
    ...
    description:
        "Une boutique en ligne construite avec Angular et Symfony",
    tags: ["Angular", "Typescript", "Tailwind CSS", "Symfony", "MySQL", "API Platform"],
    link: "#",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description:
        "Création du jeu de serpent en python.",
  ...
  },
  {
    ...
    title: "Brick breaker",
    description:
        "Création du je de casse-brique en python.",
    tags: ["Python", "Pygame"],
    link: "#",
  },
  {
    ...
    title: "Minesweeper",
    description:
        "Création du jeu de mines en python.",
    tags: ["Python", "Tkinter"],
    link: "#",
  },
];
